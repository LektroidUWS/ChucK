...
function void player1(int N[], int D[], float V[], Sound1 generator, Event start){
    while( true){
        //0 => s.gain ;
        start => now;
...
function void player2(int N[], int D[], float V[], Sound2 generator, Event start){
    while( true){
        //0 => s.gain ;
        start => now;
        for (1 => int i; i <= 4; i++) {// four repeats
...
function void player3(int N[], int D[], float V[], Sound3 generator, Event start){
    while( true){
        //0 => s.gain ;
        start => now;
        for (1 => int i; i <= 4; i++) {// four repeats
